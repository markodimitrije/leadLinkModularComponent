...
//        let rowHeight = getOneRowHeightFor(componentType: "textField")
//
//        let txtHeight = getOneRowHeightFor(componentType: "textField")
//        let txtFrm = CGRect.init(origin: CGPoint.zero, size: CGSize.init(width: viewFactory.bounds.width, height: txtHeight))
//
//        let components_1 = viewFactory.createLabelAndTextView(count: 3) // glup interfejs, embed-uj ovo (*)
//        let a = viewFactory.stackElementsInOneRow(components: components_1, rowHeight: rowHeight) // u ovo (**) // sakrij unutra...
//
//        let components_2 = viewFactory.createLabelAndTextView(count: 1)
//        let b = viewFactory.stackElementsInOneRow(components: components_2, rowHeight: rowHeight)
//
//        let components_3 = viewFactory.createLabelAndTextView(count: 2)
//        let c = viewFactory.stackElementsInOneRow(components: components_3, rowHeight: rowHeight)
