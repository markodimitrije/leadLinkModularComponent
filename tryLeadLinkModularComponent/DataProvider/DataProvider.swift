...
class SingleQuestion {
    ...
    init?(forQuestion id: Int) {
        ...
        case 0:
            ...
            let q = Question.init(id: 12, type: QuestionType.radioBtnWithInput, headlineText: "Headline", inputTxt: "whatever", options: options, multipleSelection: false)
        ...
        case 1:
            ...
            let q = Question.init(id: 77, type: QuestionType.checkboxWithInput, headlineText: "Fruits", inputTxt: "Choose your favourite", options: options, multipleSelection: false)
        ...
        case 2:
            ...
            let q = Question.init(id: 177, type: QuestionType.switchBtn, headlineText: "Preferences", inputTxt: "Choose your preferences", options: options, multipleSelection: true)
            // ovo ces izvuci iz REALM-a! ili dataLayer-a:
        ...
        case 3:
            let options = ["Paris", "London", "Maroco", "Madrid", "Moscow"]
            let q = Question.init(id: 3, type: QuestionType.radioBtn, headlineText: "Headline", inputTxt: "whatever", options: options, multipleSelection: false)
        ...
        case 4:
            ...
            let q = Question.init(id: 2, type: QuestionType.checkbox, headlineText: "Sports", inputTxt: "whatever", options: options, multipleSelection: true)
            // ovo ces izvuci iz REALM-a! ili dataLayer-a:
            let answer = CheckboxAnswer.init(questionId: q.id, optionId: [1,2,3,4], content: ["Basketball", "Swimming", "Tennis", "Waterpolo"])
            (self.question, self.answer) = (q, answer)
        case 5:
            let q = Question.init(id: 10, type: QuestionType.textField, headlineText: "First name", inputTxt: "type your name", options: [ ], multipleSelection: false)
